    ...
    //  輪郭が非対称なので、四角いアパート/マンションとシルエットだけで見分けられる。専有率48%で一回り小さく見せる（2026-08-12 変更）。
    const ICON_SMALL_BLDG = '<svg viewBox="0 0 24 24" style="width:48%;height:48%;fill:currentColor;display:block;" aria-hidden="true"><path fill-rule="evenodd" d="M2.3 4.4 h12.8 v2 h-12.8 Z M3.7 6.4 h10 v4.6 h8 v10 h-18 Z M6.6 8.8 h4.2 v3.2 h-4.2 Z M6.9 15.4 h3.6 v5.6 h-3.6 Z M15.9 15.4 h3.6 v5.6 h-3.6 Z"/></svg>';
